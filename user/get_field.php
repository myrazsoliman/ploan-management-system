<?php
    ...
    $tbl_loan    = $db->conn->query("SELECT * FROM `loan` INNER JOIN `borrowers` ON loan.borrower_id=borrowers.borrower_id INNER JOIN `loan_plan` ON loan.lplan_id=loan_plan.lplan_id WHERE `loan_id`='$loan_id'");
